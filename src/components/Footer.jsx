      ...
      <div className="container">
        <div className="footer-content">
          ...
          <div className="footer-links">
            <a href="https://pump.fun/coin/J7hX5qVuJuiUiuZ1AkqE7eVS3sjTJ5kgFnuJwR2Rpump" target="_blank" rel="noopener noreferrer" className="footer-link">Pump.fun</a>
            ...
            <a href="https://dexscreener.com/solana/auqivmakuefz78czbeqagbsffj3tgu2gwfmgbhmvgjbq" target="_blank" rel="noopener noreferrer" className="footer-link">DexScreener</a>
          </div>
        </div>
      </div>
    </footer>
